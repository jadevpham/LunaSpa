	...
	lookup(_ref) {
		...
		if (typeof window !== "undefined") {
			...
			if (
				...
				((_a = window.location.hash) == null ? void 0 : _a.indexOf("?")) > -1
			) {
...
var subdomain = {
	...
	lookup(_ref) {
		...
		const language =
			...
			((_b = (_a = window.location) == null ? void 0 : _a.hostname) == null
				? void 0
				: _b.match(/^(\w{2,5})\.(([a-z0-9-]{1,63}\.[a-z]{2,6})|localhost)/i));
