...
var consoleLogger = {
	...
	output(type, args) {
		var _a, _b;
		(_b =
			(_a = console == null ? void 0 : console[type]) == null
				? void 0
				: _a.apply) == null
			? void 0
...
var ResourceStore = class extends EventEmitter {
	...
	getResource(lng, ns, key) {
		...
		return deepFind(
			(_b = (_a = this.data) == null ? void 0 : _a[lng]) == null
				? void 0
				: _b[ns],
			key,
			keySeparator,
		...
		processors.forEach((processor) => {
			...
			value =
				((_a = this.processors[processor]) == null
					? void 0
					: _a.process(value, key, options, translator)) ?? value;
		});
		return value;
	},
};
...
var Translator = class _Translator extends EventEmitter {
	...
	translate(keys, options, lastKey) {
		...
		const resExactUsedKey =
			(resolved == null ? void 0 : resolved.exactUsedKey) || key;
		const noObject = [
			"[object Number]",
			"[object Function]",
			"[object RegExp]",
			...
			if (usedKey || usedDefault || updateMissing) {
				...
				const send = (l, k, specificDefaultValue) => {
					...
					if (this.options.missingKeyHandler) {
						...
						(_a = this.backendConnector) == null ? void 0 : _a.saveMissing
					) {
	...
	extendTranslation(res, key, options, resolved, lastKey) {
		...
		if ((_a = this.i18nFormat) == null ? void 0 : _a.parse) {
			...
			const skipOnVariables =
				isString(res) &&
				(((_b = options == null ? void 0 : options.interpolation) == null
					? void 0
					: _b.skipOnVariables) !== void 0
			...
			if (options.nest !== false)
				res = this.interpolator.nest(
					...
					function () {
						...
						if (
							(lastKey == null ? void 0 : lastKey[0]) === args[0] &&
							!options.context
						) {
							_this.logger.warn(
...
var PluralResolver = class {
	...
	needsPlural(code) {
		...
		return (
			(rule == null ? void 0 : rule.resolvedOptions().pluralCategories.length) >
			1
		);
	}
...
var Interpolator = class {
	constructor() {
		...
		this.options = options;
		this.format =
			((_a = options == null ? void 0 : options.interpolation) == null
				? void 0
				: _a.format) || ((value) => value);
		this.init(options);
	}
	init() {
		let options =
	...
	resetRegExp() {
		const getOrResetRegExp = (existingRegExp, pattern) => {
			if (
				(existingRegExp == null ? void 0 : existingRegExp.source) === pattern
			) {
	...
	interpolate(str, data, lng, options) {
		...
		const missingInterpolationHandler =
			(options == null ? void 0 : options.missingInterpolationHandler) ||
	...
	nest(str, fc) {
		...
		const handleHasOptions = (key, inheritedOptions) => {
			...
			if (
				(((matchedSingleQuotes == null ? void 0 : matchedSingleQuotes.length) ??
					0) %
					2 ===
					0 &&
					!matchedDoubleQuotes) ||
	...
	format(value, format, lng) {
		...
		const result = formats.reduce((mem, f) => {
			...
			if (this.formats[formatName]) {
				...
				try {
					const valOptions =
						((_a = options == null ? void 0 : options.formatParams) == null
							? void 0
							: _a[options.interpolationkey]) || {};
					const l =
						valOptions.locale ||
						valOptions.lng ||
						options.locale ||
...
var Connector = class extends EventEmitter {
	constructor(backend, store, services) {
		...
		(_b = (_a = this.backend) == null ? void 0 : _a.init) == null
			? void 0
			: _b.call(_a, services, options.backend, options);
	}
...
var transformOptions = (options) => {
	...
	if (
		((_b = (_a = options.supportedLngs) == null ? void 0 : _a.indexOf) == null
			? void 0
			: _b.call(_a, "cimode")) < 0
	) {
...
var I18n = class _I18n extends EventEmitter {
	...
	changeLanguage(lng, callback) {
		...
		const setLng = (lngs) => {
			...
			if (l) {
				...
				(_b =
					(_a = this.services.languageDetector) == null
						? void 0
						: _a.cacheUserLanguage) == null
					? void 0
					: _b.call(_a, l);
			}
	...
	dir(lng) {
		...
		const languageUtils =
			((_b = this.services) == null ? void 0 : _b.languageUtils) ||
