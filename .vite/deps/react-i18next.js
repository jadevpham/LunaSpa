...
var warn = (i18n, code, msg, rest) => {
	...
	if (
		(_b =
			(_a = i18n == null ? void 0 : i18n.services) == null
				? void 0
				: _a.logger) == null
			? void 0
			: _b.forward
	...
	if (
		(_d =
			(_c = i18n == null ? void 0 : i18n.services) == null
				? void 0
				: _c.logger) == null
			? void 0
			: _d.warn
...
var hasLoadedNamespace = (ns, i18n, options = {}) => {
	...
	return i18n.hasLoadedNamespace(ns, {
		...
		precheck: (i18nInstance2, loadNotPending) => {
			var _a;
			if (
				((_a = options.bindI18n) == null
					? void 0
					: _a.indexOf("languageChanging")) > -1 &&
...
var hasChildren = (node, checkLength) => {
	...
	const base =
		((_a = node.props) == null ? void 0 : _a.children) ?? node.children;
...
var nodesToString = (children, i18nOptions, i18n, i18nKey) => {
	...
	const keepArray = (
		i18nOptions == null ? void 0 : i18nOptions.transSupportBasicHtmlNodes
	)
	...
	const mapAST = (reactNode, astNode, rootReactNode) => {
		...
		return astNodes.reduce((mem, node, i2) => {
			...
			const translationContent =
				((_b = (_a = node.children) == null ? void 0 : _a[0]) == null
					? void 0
					: _b.content) &&
...
function Trans({
	...
	let namespaces =
		ns || t2.ns || ((_b = i18n.options) == null ? void 0 : _b.defaultNS);
...
var composeInitialProps = (ForComponent) => async (ctx) => {
	...
	const componentsInitialProps =
		(await ((_a = ForComponent.getInitialProps) == null
			? void 0
			: _a.call(ForComponent, ctx))) ?? {};
...
var getInitialProps = () => {
	...
	const i18n = getI18n();
	const namespaces =
		((_a = i18n.reportNamespaces) == null ? void 0 : _a.getUsedNamespaces()) ??
		[];
	const ret = {};
...
function Trans2({
	...
	return Trans({
		...
		ns:
			...
			((_a = i18n == null ? void 0 : i18n.options) == null
				? void 0
				: _a.defaultNS),
		i18n,
		t: tFromProps,
...
var useTranslation = (ns, props = {}) => {
	...
	let namespaces =
		ns ||
		defaultNSFromContext ||
		((_b = i18n.options) == null ? void 0 : _b.defaultNS);
	namespaces = isString(namespaces)
		? [namespaces]
		: namespaces || ["translation"];
	(_d = (_c = i18n.reportNamespaces).addUsedNamespaces) == null
		? void 0
		: _d.call(_c, namespaces);
	const ready =
