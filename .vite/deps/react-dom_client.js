import { require_react_dom } from "./chunk-WOWBALJJ.js";
		...
		(function () {
			...
			function scheduleRoot(root2, element) {
				root2.context === emptyContextObject &&
					(updateContainerSync(element, root2, null, null), flushSyncWork$1());
			}
			...
			function describeFiber(fiber) {
				switch (fiber.tag) {
					...
					case 15:
						return (
							(fiber = describeNativeComponentFrame(fiber.type, false)), fiber
						);
					case 11:
						return (
							(fiber = describeNativeComponentFrame(fiber.type.render, false)),
							fiber
						);
					case 1:
						return (
							(fiber = describeNativeComponentFrame(fiber.type, true)), fiber
						);
					default:
						return "";
				}
			...
			function updatedAncestorInfoDev(oldInfo, tag) {
				...
				-1 !== buttonScopeTags.indexOf(tag) &&
					(oldInfo.pTagInButtonScope = null);
			...
			function validateDOMNesting(childTag, ancestorInfo) {
				...
				var warnKey =
					String(!!parentInfo) + "|" + childTag + "|" + ancestorInfo;
			...
			function finishRenderingHooks(current2, workInProgress2) {
				...
				hookTypesUpdateIndexDev = -1;
				null !== current2 &&
					(current2.flags & 31457280) !== (workInProgress2.flags & 31457280) &&
					console.error(
			...
			function bailoutHooks(current2, workInProgress2, lanes) {
				...
				workInProgress2.flags =
					(workInProgress2.mode & StrictEffectsMode) !== NoMode
						? workInProgress2.flags & -201328645
			...
			function updateOffscreenComponent(
				...
				var nextProps = workInProgress2.pendingProps,
					...
					nextIsDetached =
						0 !==
						(workInProgress2.stateNode._pendingVisibility & OffscreenDetached),
			...
			function updateClassComponent(
				...
				if (null === workInProgress2.stateNode) {
					...
					(workInProgress2.mode & StrictEffectsMode) !== NoMode &&
						(workInProgress2.flags |= 67108864);
					_instance = true;
				...
				if (lane || state) {
					...
					ReactSharedInternals.getCurrentStack =
						null === workInProgress2 ? null : getCurrentFiberStackInDev;
					isRendering = false;
			...
			function updateSuspenseComponent(
				...
				if (null === current2) {
					if (isHydrating) {
						JSCompiler_object_inline_componentStack_2319
							...
							: reuseSuspenseHandlerOnStack(workInProgress2);
						if (isHydrating) {
							var JSCompiler_object_inline_message_2316 =
								nextHydratableInstance;
							var JSCompiler_temp;
					...
					if (JSCompiler_object_inline_componentStack_2319)
						return (
							...
							(JSCompiler_object_inline_message_2316.return = workInProgress2),
							(JSCompiler_object_inline_stack_2318.return = workInProgress2),
							(JSCompiler_object_inline_message_2316.sibling =
								JSCompiler_object_inline_stack_2318),
							(workInProgress2.child = JSCompiler_object_inline_message_2316),
							(JSCompiler_object_inline_componentStack_2319 =
								workInProgress2.child),
				...
				if (
					...
					if (didSuspend)
						workInProgress2.flags & 256
							...
							: null !== workInProgress2.memoizedState
								...
								: (reuseSuspenseHandlerOnStack(workInProgress2),
									...
									(JSCompiler_object_inline_stack_2318.return =
										workInProgress2),
									(JSCompiler_object_inline_componentStack_2319.return =
										workInProgress2),
									(JSCompiler_object_inline_stack_2318.sibling =
										JSCompiler_object_inline_componentStack_2319),
									(workInProgress2.child = JSCompiler_object_inline_stack_2318),
									reconcileChildFibers(
										workInProgress2,
										current2.child,
										null,
									...
									(JSCompiler_object_inline_stack_2318 = workInProgress2.child),
						...
						SUSPENSE_PENDING_START_DATA
							? ((workInProgress2.flags |= 128),
								(workInProgress2.child = current2.child),
								(workInProgress2 = retryDehydratedSuspenseBoundary.bind(
									null,
									current2,
								)),
				...
				if (JSCompiler_object_inline_componentStack_2319)
					return (
						...
						(JSCompiler_object_inline_componentStack_2319 =
							JSCompiler_object_inline_stack_2318.fallback),
						(JSCompiler_object_inline_message_2316 = workInProgress2.mode),
						...
						null === JSCompiler_object_inline_message_2316
							...
							: ((JSCompiler_temp =
								...
								(JSCompiler_object_inline_message_2316 = {
									baseLanes:
										JSCompiler_object_inline_message_2316.baseLanes |
										renderLanes2,
				...
				null !== current2 &&
					((JSCompiler_object_inline_digest_2317 = workInProgress2.deletions),
					null === JSCompiler_object_inline_digest_2317
						? ((workInProgress2.deletions = [current2]),
							(workInProgress2.flags |= 16))
						: JSCompiler_object_inline_digest_2317.push(current2));
				...
				switch (workInProgress2.tag) {
						...
						a: {
							...
							if (prevSibling.isDehydrated)
								if (
									...
									(workInProgress2.updateQueue.baseState = prevSibling),
					...
					case 27:
						return (
							...
							null === current2 &&
								...
								(prevSibling = workInProgress2.stateNode =
					...
					case 6:
						return (
							null === current2 &&
								...
								(renderLanes2 = getHostContext().ancestorInfo.current),
								(current2 =
									null != renderLanes2
										? validateTextNesting(current2, renderLanes2.tag)
										: true),
					...
					case 10:
						return (
							...
							pushProvider(workInProgress2, returnFiber, nextProps),
							reconcileChildren(
								current2,
								workInProgress2,
			...
			function entangleTransitions(root2, fiber, lane) {
				...
				if (
					null !== fiber &&
					((fiber = fiber.shared), 0 !== (lane & 4194176))
				) {
			...
			function commitMutationEffectsOnFiber(finishedWork, root2) {
				...
				switch (finishedWork.tag) {
					...
					case 22:
						...
						offscreenSubtreeWasHidden =
							prevOffscreenSubtreeWasHidden || nextNode;
						recursivelyTraverseMutationEffects(root2, finishedWork);
						offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
					...
					detach: function () {
						...
						if (0 === (instance._pendingVisibility & OffscreenDetached)) {
							...
							null !== root2 &&
								...
								scheduleUpdateOnFiber(root2, fiber, 2));
						}
					},
					attach: function () {
						var instance = primaryChildInstance,
				...
				switch (workInProgress2.tag) {
							...
							if (popHydrationState(workInProgress2)) {
								...
								if (null !== returnFiber)
									switch (returnFiber.tag) {
										...
										case 27:
										case 5:
											(renderLanes2 = returnFiber.memoizedProps),
												_type &&
													((_type = diffHydratedTextForDevWarnings(
														current2,
														newProps,
								...
								current2[internalInstanceKey] = workInProgress2;
								current2 =
									current2.nodeValue === newProps ||
									(null !== renderLanes2 &&
										true === renderLanes2.suppressHydrationWarning) ||
									checkForUnmatchedText(current2.nodeValue, newProps)
										? true
										: false;
								current2 || throwOnHydrationMismatch(workInProgress2);
							} else
								(renderLanes2 = renderLanes2.ancestorInfo.current),
									null != renderLanes2 &&
										validateTextNesting(newProps, renderLanes2.tag),
									(current2 =
					...
					case 13:
						...
						newProps &&
							((renderLanes2 = workInProgress2.child),
							(_type = null),
							null !== renderLanes2.alternate &&
								null !== renderLanes2.alternate.memoizedState &&
								null !== renderLanes2.alternate.memoizedState.cachePool &&
								(_type = renderLanes2.alternate.memoizedState.cachePool.pool),
							(returnFiber = null),
							null !== renderLanes2.memoizedState &&
								null !== renderLanes2.memoizedState.cachePool &&
								(returnFiber = renderLanes2.memoizedState.cachePool.pool),
							returnFiber !== _type && (renderLanes2.flags |= 2048));
						newProps !== current2 &&
							newProps &&
									...
									for (current2 = workInProgress2.child; null !== current2; ) {
										...
										if (null !== returnFiber) {
											...
											for (
												...
												resetWorkInProgress(newProps, current2),
							...
							newProps
								? 0 !== (renderLanes2 & 536870912) &&
									...
									workInProgress2.subtreeFlags & 6 &&
										(workInProgress2.flags |= 8192))
								: bubbleProperties(workInProgress2),
							(newProps = workInProgress2.updateQueue),
							null !== newProps &&
								scheduleRetryEffect(workInProgress2, newProps.retryQueue),
							(newProps = null),
							null !== current2 &&
								null !== current2.memoizedState &&
								null !== current2.memoizedState.cachePool &&
								(newProps = current2.memoizedState.cachePool.pool),
							(renderLanes2 = null),
							null !== workInProgress2.memoizedState &&
								null !== workInProgress2.memoizedState.cachePool &&
								(renderLanes2 = workInProgress2.memoizedState.cachePool.pool),
							renderLanes2 !== newProps && (workInProgress2.flags |= 2048),
			...
			function commitRootImpl(
				...
				if (null !== recoverableErrors)
					for (
						renderPriorityLevel = root2.onRecoverableError, finishedWork = 0;
				...
				try {
					disappearLayoutEffects(fiber),
						...
						shouldDoubleInvokePassiveEffects &&
							reconnectPassiveEffects(root2, fiber, 0, null, false);
				} finally {
					setIsStrictModeForDevtools(false);
				}
			}
			...
			HooksDispatcherOnMountInDEV.useFormState = function (
				action,
				initialState,
			) {
			...
			InvalidNestedHooksDispatcherOnUpdateInDEV.useHostTransitionStatus =
				useHostTransitionStatus;
			InvalidNestedHooksDispatcherOnUpdateInDEV.useFormState = function (
				action,
			) {
				currentHookNameInDev = "useFormState";
				warnInvalidHookAccess();
