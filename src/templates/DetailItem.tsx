			...
			<div className="container w-full mx-auto relative">
				<div className="flex flex-col gap-2">
					...
					<div className="flex items-center gap-4 text-gray-700">
                        ...
                        <p className="text-gray-800 font-semibold">From 									{new Intl.NumberFormat("vi-VN", {
										style: "currency",
										currency: "VND",
									}).format(priceMin)}</p>
						</div>
								...
								{[1, 2, 3, 4].map((service) => (
									...
									>
										<div>
											...
											<p className="text-sm text-gray-500">{durationsNameMin} - {durationsNameMax}</p>
											<p className="text-gray-800 font-semibold">From 									{new Intl.NumberFormat("vi-VN", {
										style: "currency",
										currency: "VND",
									}).format(priceMin)}</p>
                                            <p className="flex items-start gap-2 text-gray-600"> {address}</p>
										</div>
